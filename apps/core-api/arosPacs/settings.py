"""
Django settings for arosPacs project.
...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-generate-new-key-for-production')
...
# Use DATABASE_URL for PostgreSQL in production, SQLite for local development
