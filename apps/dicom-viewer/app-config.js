window.config = {
  ...
  servers: {
    dicomWeb: [
      {
        name: 'AROS_PACS',
        wadoUriRoot: 'http://localhost:8000/api/v1/gateway/wado/demo-clinic',
        qidoRoot: 'http://localhost:8000/api/v1/gateway/wado/demo-clinic',
        wadoRoot: 'http://localhost:8000/api/v1/gateway/wado/demo-clinic',
