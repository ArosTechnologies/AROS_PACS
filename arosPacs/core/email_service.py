...
def send_welcome_email(user):
    ...
    """
    # DO NOT TRANSLATE UI/EMAIL STRINGS
    subject = '¡Bienvenido a AROS PACS!'
...
def send_study_completed_email(study):
    ...
    # DO NOT TRANSLATE UI/EMAIL STRINGS
    subject = 'Tu estudio está listo — AROS PACS'
...
def send_doctor_approved_email(user):
    ...
    """
    # DO NOT TRANSLATE UI/EMAIL STRINGS
    subject = '¡Tu cuenta ha sido aprobada! — AROS PACS'
...
def send_doctor_denied_email(email, name):
    ...
    """
    # DO NOT TRANSLATE UI/EMAIL STRINGS
    subject = 'Solicitud de cuenta — AROS PACS'
